...
interface LibraryDao {
    ...
    companion object {
        ...
        /**
         * Every library manga with its category, the unread and read chapter counts per scanlator
         * and uploader, and the bookmarked and unavailable chapter counts.
         */
    ...
    @Query(LIBRARY_QUERY) fun observeLibrary(): Flow<List<LibraryMangaRaw>>

    @Query(LIBRARY_QUERY) fun getLibraryList(): List<LibraryMangaRaw>
}
